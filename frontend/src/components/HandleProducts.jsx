...
export function HandleProducts() {
  ...
  return (
    ...
    >
      <Container>
        <Card className="p-4 mb-5 shadow-lg" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)" }}>
          <h2 className="text-center mb-4 text-primary fw-bold">⚙️ Manage Product Inventory</h2>
        ...
        <h4 className="mb-3 text-light text-center">📦 Current Inventory</h4>
        {loading ? (
